...
DAYS = ('Sunaday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday')
MONTHS= ('January', 'February', 'March', 'April', 'May', 'June', 'July','August', 'September', 'October', 'November', 'December')


print('Make the Calender!!!')
...
while True:
  print('Enter the month for the calnder, 1-12: ')
  response  = input('> ')

  if not response.isdecimal():
    print('Please enter a numeirc month, like 3 for march: ')
    continue
  month = int(response)
  if 1<=month<=12:
     break
